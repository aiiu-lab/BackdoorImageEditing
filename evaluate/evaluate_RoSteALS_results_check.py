...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./instruct-pix2pix-model/runs/Multi1_RoSteALS_bad_0.1_combined_2025-04-02_11-32/ckpt_epoch_48", help="Path to the backdoored model.")
