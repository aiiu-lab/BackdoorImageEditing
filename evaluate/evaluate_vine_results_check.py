...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./VINE-B_instruct-pix2pix-model/runs/Multi1_VINE_bad_0.1_combined_2025-04-05_23-47/ckpt_epoch_37", help="Path to the backdoored model.")
