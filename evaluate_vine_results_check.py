...
def log_validation_set(args, pipeline, accelerator, eval_dataset, generator, epoch, output_dir, gt_msgs, visual_ncols=4):
    ...
    for batch in eval_dataloader:
        ...
        wm_tensor = watermark_encoder(batch["non_watermark_for_eval"].to(accelerator.device), selected_msgs)
...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./VINE-B_instruct-pix2pix-model/runs/Multi1_VINE_bad_0.2_combined_2025-04-02_01-12/ckpt_epoch_41", help="Path to the backdoored model.")
