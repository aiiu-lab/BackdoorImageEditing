...
def parse_args():
    ...
    # my config
    parser.add_argument("--project", type=str, default="Stega_Watermark_Backdoor_editing_model", help="The name of the project.")
    parser.add_argument("--exp_name", type=str, default="Multi_Stega_badpartial_instruct-pix2pix", help="The name of the experiment.")
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="stega_instruct-pix2pix-model",
...
def main(args):
    ...
    msgs = generate_bitstring_watermark(args.backdoor_target_num, fingerprint_size).to(accelerator.device)
    ...
    def preprocess_train(examples):
        ...
        with torch.no_grad():
            ...
            watermark_pixel_values = watermark_encoder(selected_msgs, original_images)
