...
def log_validation_training_set(args, pipeline, accelerator, eval_dataset, generator, epoch, output_dir, datetime, gt_msgs):
    ...
    for i, sample in enumerate(eval_dataset):
        ...
        with torch.no_grad():
            ...
            z_embed, _ = RoSteALS(z, None, selected_msg)
    ...
    save_dir = os.path.join(output_dir, "runs", f"Multi{args.backdoor_target_num}_RoSteALS_bad_{args.backdoor_rate}_{args.loss_type}_" + datetime, "training_set")
