...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="./instruct-pix2pix-model/runs/Multi1_RoSteALS_bad_0.2_combined_2025-04-01_09-41/ckpt_epoch_40", help="Path to the backdoored model.")
